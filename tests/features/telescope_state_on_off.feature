...
Scenario Outline: telescopeState should be ON if atleast one dish is available
    ...
    And dishes SKA001, SKA036, SKA077, SKA100 are in dish mode <DishModeSKA001>, <DishModeSKA036>, <DishModeSKA077>, <DishModeSKA100> respectively
    Then telescopeState is in DevState.ON

    Examples:
      | DishModeSKA001 | DishModeSKA036 | DishModeSKA077 | DishModeSKA100 |
